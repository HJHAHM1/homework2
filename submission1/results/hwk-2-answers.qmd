...
ggplot(full.hcris.data.multiple, aes(x = year, y = num_hospitals)) +
  ...
  labs(title = "Number of Hospitals With More than One Report per Year",
       x = "Fiscal Year",
...
#| echo: false
#| label: tbl-mult
#| tbl-cap: Unique hospitals with multiple reports

options(knitr.kable.NA = 0)
knitr::kable(num_unique_providers, digits=0)
