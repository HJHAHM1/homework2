...
full.hcris.data_multiple <- full.hcris.data %>%
...
ggplot(full.hcris.data_multiple, aes(x = year, y = num_hospitals)) +
...
```{r}
# Checking results from iverse variance matching
...
# Since p.value doesn't seem to be directly available in the structure, 
# you can either compute it manually or leave it out. 
# Assuming you want to leave it out for now.
